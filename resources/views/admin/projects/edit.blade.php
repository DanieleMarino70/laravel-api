                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col">
                           ...
                           <input type="checkbox" id="technology-{{$technology->id}}" value="{{$technology->id}}" class="form-check-control" name="technologies[]" @if(in_array($technology->id, $project_technologies)) checked @endif>
                        </div>
                        @endforeach
                    </div>
                </div>
